...
const startIdx = css.indexOf('/* CTA Gradient Glow */');
if (startIdx !== -1) {
...
#cta-section::before {
    ...
    left: 0;
    right: 0;
    height: 196px; /* 30% shorter than 280px */
    background: radial-gradient(100% 100% at bottom center, rgba(46,255,208, 0.8) 0%, rgba(30,186,151, 0.5) 40%, rgba(30,186,151, 0) 100%);
